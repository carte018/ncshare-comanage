...
//  public $order = array("id");
  ...
  /* RGC - duplicate of confirmation sender that doesn't send and returns redirect
   * url for skipping email validation step */

  public function sendFakeConfirmation($id, $actorCoPersonId) {
    ...
    /* RGC */ /*$coInviteId = $this->CoInvite->send($pt['CoPetition']['enrollee_co_person_id'],
                                        ...
                                        $skip_invite);
   */ 
   /* RGC */ $retarray = $this->CoInvite->getInvitationFragment($pt['CoPetition']['enrollee_co_person_id'],
								$pt['CoPetition']['enrollee_org_identity_id'],
								$toEmail['mail']);
   /* RGC */ $retcode = $retarray['frag'];

   /* RGC */ /*$coInviteId = $this->CoInvite->getIdcarrier();*/
   /* RGC */ $coInviteId = $retarray['otherid'];
