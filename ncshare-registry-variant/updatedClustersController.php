...
// XXX we probably want $managed, but do we want $self?
    ...
    $self = false;
    /*
     * RGC - this if was originally commented.  Uncommented to enable $self
     * permissions in cluster viewing, so that users don't get hard errors 
     * when clicking first-level links in the registry UI.  This is primarily
     * a cosmetic adjustment, since users will still get denied update access if 
     * they attempt to change cluster information.
     */
